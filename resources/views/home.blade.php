...
<section class="ftco-intro">
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row align-items-center">
	            ...
	            <p class="mb-4" style="color:white">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
    ...
    <section class="ftco-counter ftco-bg-dark img" id="section-counter" style="background-image: url('{{ asset('assets/images/bg_3.jpg') }}');" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
      <div class="container">
				...
				<div class="col-md-3">
					<div class="menu-entry">
							...
							<div class="text text-center pt-4">
								<h3 style="color:white"><a href="#">{{$product->name}}</a></h3>
